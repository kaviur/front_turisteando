  ...
  return (
    <li>
      <Link
        ...
        onClick={handleClick}
        className={`${
          isItemActive ? "bg-secondary bg-opacity-10 text-secondary" : ""
        } group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:text-secondary`}
      >
        {item.icon}
        {item.label}
        {item.children && (
